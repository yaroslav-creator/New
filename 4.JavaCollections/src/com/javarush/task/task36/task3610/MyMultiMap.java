...
public class MyMultiMap<K, V> extends HashMap<K, V> implements Cloneable, Serializable {
     ...
     * Если по такому ключу количество значений равняется repeatCount - то удали из листа
     * в объекте map элемент с индексом ноль, и добавь в конец листа value.
     ...
     * Если по этому ключу хранится несколько элементов - должен удаляться элемент
     * из листа с индексом ноль. Если по какому-то ключу хранится лист размером ноль элементов
    ...
    /**
     * boolean containsKey(Object key) - должен вернуть true,
