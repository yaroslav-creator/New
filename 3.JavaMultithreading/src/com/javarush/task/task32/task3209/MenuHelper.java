...
public class MenuHelper {
    ...
    public static JMenuItem addMenuItem(JMenu parent, String text, ActionListener actionListener) {
        //Создавает новый пункт меню JMenuItem, используя text.
        JMenuItem menuItem = new JMenuItem( text );

        // Устанавливает этому пункту слушателя действий с помощью метода addActionListener()
        menuItem.addActionListener( actionListener );

        // Добавляет в parent созданный пункт меню.
        parent.add( menuItem );
    ...
    //Метод, который добавляет в parent новый пункт меню с текстом text и действием action при выборе этого метода.
