...
public class Solution {
    ...
    public Object get(Object key) {
        int hash = hash(key);
        //В методе get() класса Solution в synchronized блоке используй lock
        // из массива locks в зависимости от хэша объекта и количества лок объектов.
        //было synchronized(this)
    ...
    public void clear() {
        for (int i = 0; i < buckets.length; i++) {
            //В методе clear() класса Solution в synchronized блоке используй lock
            // из массива locks в зависимости от индекса элемента и количества лок объектов.
            //было synchronized(this)
