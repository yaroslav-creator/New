...
public class GameObject {
    ...
    //метод, который будет проверять, возможность столкновения
    ...
    //метод, который будет проверять, столкновения и изменение объекта
    ...
    //метод, который будет проверять, координаты столкновения(пересечения) у объекта
